...
This is a nuanced "nested" workflow that relies on your employer's routing to bridge your physical location (Work WiFi) with your virtualized lab environment (GNS3/VMware), using Network Address Translation (NAT) to traverse the boundaries.
