...
![](./small_example_network.png)

_Figure 1-3. A small example network_
...
_To avoid confusion between routers and switches or hubs, Ethernets are drawn in this and other examples to resemble a strand of coaxial wiring with terminators at the ends and with hosts and routers connecting to the coax wire in different places._
...
_Figure 1-4. The differences between IGP and EGP views_
...
![](./example_bgp_connectivity.png)

_Figure 1-5. Example BGP connectivity between ISPs and customers_
...
_The relationship between traffic and cost is usually indirect, but in the long run, it’s cheaper to upgrade a peering connection for more traffic rather than a transit connection. The business case for peering with other networks is discussed later in the book._
