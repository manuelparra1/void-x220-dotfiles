...
> Foundational Networking Knowledge (Prerequisites)
...
## 8. Final Challenge: Build Your Own BGP Network
...
# 2. Establishing BGP Sessions: Neighbors & Adjacency
...
# 3. The Conversation: BGP Messages & Finite State Machine
...
# 4. The Payload: NLRI, Attributes, and Route Selection
...
# 5. BGP Architecture: Underlay, Overlay, and Loops
...
# 6. Implementation Strategy: iBGP over OSPF
