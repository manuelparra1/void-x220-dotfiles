...
These commands progress from basic reachability (ping) to TCP-specific testing (telnet, show tcp) to path analysis (traceroute), helping narrow down whether the issue is routing, firewall/ACL related, or something else entirely.
