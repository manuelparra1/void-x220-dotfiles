...
# I’m a CLI lifer who learned to love automation | Nokia

Nokia.com

[View all Nokia sites](#)
...
* Solutions [Solutions](/networks/)
  
  Solutions
  
  Discover the advanced connectivity delivered by AI-powered network solutions with high performance and security. All backed by the trusted expertise to help you design, deploy and operate across mobile, fixed and transport networks.
  
  [Network solutions](/networks/)
* Insights and innovation [Insights and innovation](/insights/)
...
* Collaborate with us [Collaborate with us](/collaborate-with-us/)
...
* We are Nokia [We are Nokia](/we-are-nokia/)
  
  We are Nokia
  
  Nokia is advancing connectivity for the AI era, bringing global leadership across fixed, mobile, and transport networks.
...
1. [Blog](/blog/)
2. Confessions of a CLI lifer who learned to love automation
...
[IP Networks](/blog/tag/ip-networks/) [Optical Networks](/blog/tag/optical-networks/) [Data center networks](/blog/tag/data-center-networks/) [Data center networking](/blog/tag/data-center-networking/) [NetOps](/blog/tag/netops/) [Automation](/blog/tag/automation/)

Share now on Social media

* [](https://www.linkedin.com/sharing/share-offsite/?url=https://www.nokia.com/blog/confessions-of-a-cli-lifer-who-learned-to-love-automation/ "Linkedin")
* [](https://twitter.com/intent/tweet?url=https://www.nokia.com/blog/confessions-of-a-cli-lifer-who-learned-to-love-automation/&status=Confessions of a CLI lifer who learned to love automation+https://www.nokia.com/blog/confessions-of-a-cli-lifer-who-learned-to-love-automation/ "Twitter")
* [](https://www.facebook.com/share.php?u=https://www.nokia.com/blog/confessions-of-a-cli-lifer-who-learned-to-love-automation/&title=Confessions of a CLI lifer who learned to love automation "Facebook")
* [](https://api.whatsapp.com/send?text=Check out this site https%3A%2F%2Fwww.nokia.com%2Fblog%2Fconfessions-of-a-cli-lifer-who-learned-to-love-automation%2F "WhatsApp")
* [](mailto:?subject=Confessions of a CLI lifer who learned to love automation&body=Check out this site https://www.nokia.com/blog/confessions-of-a-cli-lifer-who-learned-to-love-automation/ "Email")

## Why we use cookies and other tracking technologies

We and our third party vendors use cookies and other tracking technologies to improve your browsing experience, to personalize content, maintain security, analyze traffic and for marketing purposes. Full details are set out in the Cookie List under Cookie Policy. Essential cookies are always on. Please indicate your consent to our use of tracking technologies (other than essential cookies) by managing your preferences below. You can follow the instructions under the 'Manage preferences' section at any time to adjust your preferences. For more information on how we process your personal data please review our ‘cookie notice’ or ‘general privacy notice’. [Cookie Policy](https://www.nokia.com/cookies/) [General Privacy Notice](https://www.nokia.com/privacy/general-notice/)
