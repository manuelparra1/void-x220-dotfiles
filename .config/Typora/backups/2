...
<svg xmlns="http://www.w3.org/2000/svg" width="600" height="20">
  <clipPath id="badge-clip">
    <rect width="600" height="20" rx="3"/>
  </clipPath>
  <g clip-path="url(#badge-clip)">
    <rect width="60" height="20" fill="#8DA9C4"/> 
    <rect x="60" width="135" height="20" fill="#B6D0E2"/> 
  </g>
  <g font-family="Verdana, sans-serif" font-size="11" font-weight="bold" text-anchor="middle">
    ...
    <text x="130" y="15" fill="#fff" fill-opacity="0.5">Arcee Trinity Large</text>
    <text x="130" y="14" fill="#333">Arcee Trinity Large</text>
  </g>
</svg>
